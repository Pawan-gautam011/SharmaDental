  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className={`pill-badge fade-up ${heroInView ? "visible" : ""}`}
          ...
          >
            ...
            need some dental advice—we're here for you.
          </p>
        </div>
      </section>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {[
              [
                ...
                "Yes! We welcome walk-ins during clinic hours, though we recommend booking in advance for specific treatments to ensure minimal wait time.",
              ],
              [
                "Is dental treatment painful?",
                "We use modern pain management techniques and local anesthesia to ensure your comfort. Most patients report little to no discomfort during treatment.",
              ],
              [
                "Do you offer EMI / payment plans?",
                "Yes, we offer flexible payment options including EMI through major banks and credit cards for larger treatments.",
              ],
              [
                "How often should I visit the dentist?",
                "We recommend a routine checkup every 6 months. Patients with specific conditions may need more frequent visits based on their treatment plan.",
              ],
            ].map(([q, a]) => (
  ...
  return (
    <div
      ...
      style={{
        background: "white",
        borderRadius: 16,
        border: `1px solid ${open ? "rgba(14,165,233,0.25)" : "rgba(14,165,233,0.08)"}`,
        boxShadow: open ? "0 8px 30px rgba(14,165,233,0.08)" : "none",
        transition: "all 0.3s",
      }}
    >
      <button
